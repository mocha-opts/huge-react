import {
	unstable_ImmediatePriority as ImmediatePriority, //同步
	unstable_UserBlockingPriority as UserBlockingPriority, //点击事件
	unstable_NormalPriority as NormalPriority, //正常
...
function schedule() {
	...
	//前后work优先级一样  curCallback就不会被赋新值
...
function perform(work: Work, didTimeout?: boolean) {
	/**
	 * 1. work.priority
	 * 2. 饥饿问题 （didTimeout）过期了就要同步执行 因为要饿死了
	 * 3. 时间切片  时间用尽了就需要同步执行
	 */
